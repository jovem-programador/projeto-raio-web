  ...
  return (
    <div className="relative flex h-screen w-screen items-center justify-center bg-gradient-to-r from-red-900 via-red-800 to-red-700 overflow-hidden font-[sans-serif]">
      ...
      */}
      <div className="relative z-20 w-full max-w-lg p-6">
        <div className="rounded-3xl border border-gray-200 bg-white/90 p-12 shadow-2xl shadow-gray-200/50">
          ...
          <div className="mb-10 text-center">
            <h3 className="text-red-700 text-5xl font-extrabold flex items-center justify-center gap-2">
              <Zap className="fill-red-700 h-10 w-10" /> RAIO
            </h3>
            <p className="text-gray-900 text-xl font-bold mt-6">
              {step === 1 ? "Recuperar Acesso" : "Nova Senha"}
            </p>
            <p className="text-sm text-gray-500 mt-2 leading-relaxed">
              {step === 1 
                ? "Informe seu usuário ou e-mail para localizar sua conta." 
          ...
          <form onSubmit={step === 1 ? handleNextStep : handleRecover} className="space-y-6">
              ...
              {step === 1 ? (
                ...
                <>
                  ...
                  <input 
                    ...
                    required
                    className="bg-gray-50 focus:bg-white w-full text-sm px-5 py-4 rounded-xl border border-gray-200 focus:border-red-700 outline-none transition-all shadow-sm"
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 shadow-xl py-4 px-6 text-sm font-bold rounded-xl text-white bg-red-700 hover:bg-red-800 focus:outline-none transition-all disabled:bg-gray-400 active:scale-95"
            >
            ...
            <div className="text-center">
              <button 
                ...
                className="text-sm text-red-700 font-semibold hover:underline inline-flex items-center gap-1"
              >
                <ArrowLeft size={14} />
      ...
      {toast && (
        <div className={`fixed bottom-5 right-5 flex items-center w-full max-w-xs p-5 rounded-xl shadow-3xl border-l-4 transition-all animate-bounce z-50 ${
